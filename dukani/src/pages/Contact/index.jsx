...
export default function Contact() {
    ...
    // const btnHandler = () => {
    //   const { fullname, email, telmobile, subject, message} = data;
    //   console.log(data)
    //   alert(`Thank you Dear ${fullname} your Email is ${email} and Telphone is ${telmobile} and your subject is ${subject} and your is ${message} `);
    // };
    ...
    const onSubmit = (data) => {
        createDoc('Website Contact Messages', data)
        .then(() => {
            reset()
        ...
        <div className="container-x mx-auto">
          <div className="main-wrapper w-full lg:flex lg:space-x-[30px]">
            ...
            <div>
                    ...
                    <button className="black-btn text-sm font-semibold w-full h-[50px] flex justify-center items-center" type="submit" onClick={btnHandler} >
                      <span>Send Now</span>
                    </button>
                ...
                <h6 className="input-label text-qgray capitalize text-[13px] font-normal block mb-2 ">
                  ...
                  <div className="input-wrapper border border-qgray-border w-full h-full overflow-hidden relative ">
                  <input className="input-field placeholder:text-sm text-sm px-6 text-dark-gray w-full h-full font-normal bg-white focus:ring-0 focus:outline-none"
                    type="text"
                    placeholder="Your Dials(Number)"
                    {...register("telmobile", {
                      required: true })}
                    aria-invalid={errors.telmobile ? "true" : "false"}
                    inputClasses="h-[50px]"
                  />
                  {errors.telmobile?.type === "required"
                                                && (<p className="form-control" role="alert">Phone is required</p>)}
                  </div>
                ...
                <h6 className="input-label text-qgray capitalize text-[13px] font-normal block mb-2 ">
                  ...
                  {errors.subject?.type === "required"
                                                && (<p className="form-control" role="alert">Subject is required</p>)}
                  </div>
                ...
                <div>
                  <a href="#">
                    <button className="black-btn text-sm font-semibold w-full h-[50px] flex justify-center items-center" type="submit">
                      <span>Send Now</span>
                    </button>
                  </a>
                </div>
